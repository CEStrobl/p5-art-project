...
class Shape {
    ...
    STx = random(canvas.width, canvas.width+50);
    STy = random(0, canvas.height/2);
    ...
    shootingStarMove(){
        ...
        if (this.STx < -80 || this.STx > this.canvas.width) {

            this.STx=canvas.width
        }
        if (this.STy < 0 || this.STy > this.canvas.height) {
...
class ShootingStar extends Shape {
    ...
    draw() {
        ...
        // ellipse(this.STx, this.STy, this.w+20, this.h)

        // trails
        triangle(this.STx-5, this.STy, this.STx, this.STy+3, this.STx+85, this.STy-23)


        triangle(this.STx-12, this.STy-5, this.STx, this.STy+5, this.STx+3, this.STy-2)

        triangle(this.STx+12, this.STy+5, this.STx, this.STy+5, this.STx+3, this.STy-2)

        triangle(this.STx-5, this.STy, this.STx, this.STy+5, this.STx-12, this.STy+12)
...
var setup = function() {
    ...
    for(i = 0; i < 2; i++){
        ...
        let star = new ShootingStar(canvas)
        nightSky.push(star)
